package com.sktl.nbrbcurrency.libs;
...
import com.sktl.nbrbcurrency.Quotation;
...
public class TinyDB {
    ...
    public ArrayList<Quotation> getListObject(String key, Class<Quotation> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Quotation> objects =  new ArrayList<>();
    ...
    public void putListObject(String key, List<Quotation> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
